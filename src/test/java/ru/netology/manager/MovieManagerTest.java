...
public class MovieManagerTest {
    ...
    MovieData movie1 = new MovieData(1, "Harry1");
    MovieData movie2 = new MovieData(2, "Harry2");
    MovieData movie3 = new MovieData(3, "Harry3");
    MovieData movie4 = new MovieData(4, "Harry4");
    MovieData movie5 = new MovieData(5, "Harry5");
    MovieData movie6 = new MovieData(6, "Harry6");
    MovieData movie7 = new MovieData(7, "Harry7");
    MovieData movie8 = new MovieData(8, "Harry8");
    MovieData movie9 = new MovieData(9, "Harry9");
    MovieData movie10 = new MovieData(10, "Harry10");
